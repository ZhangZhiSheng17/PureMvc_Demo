    ...
    public class WaiterView : MonoBehaviour
    {
        ...
        List<WaiterItemView> waiters=new List<WaiterItemView>();
        private Transform parent = null;

        private void Awake()
        {
            parent = this.transform.Find("Content");
            var prefab = Resources.Load<GameObject>("UI/WaiterItem");
            objectPool=new ObjectPool<WaiterItemView>(prefab);
        }

        public void UpdataWaiter(IList<WaiterItem> waiters)
        {
